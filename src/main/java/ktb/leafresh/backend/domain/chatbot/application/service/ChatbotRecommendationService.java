...
public class ChatbotRecommendationService {
  ...
  public ChatbotRecommendationResponseDto recommendByBaseInfo(ChatbotBaseInfoRequestDto dto) {
    log.info(
        "[챗봇 추천 요청 - BaseInfo] sessionId={}, location={}, workType={}, category={}",
        dto.sessionId(),
        dto.location(),
        dto.workType(),
        dto.category());
    ...
    var aiRequest =
        new AiChatbotBaseInfoRequestDto(
    ...
    List<ChatbotRecommendationResponseDto.ChallengeDto> challenges =
        Optional.ofNullable(aiResponse.challenges()).orElse(List.of()).stream()
            .map(
                ch ->
                    ChatbotRecommendationResponseDto.ChallengeDto.builder()
                        .title(ch.title())
  ...
  public ChatbotRecommendationResponseDto recommendByFreeText(ChatbotFreeTextRequestDto dto) {
    log.info("[챗봇 추천 요청 - FreeText] sessionId={}, message={}", dto.sessionId(), dto.message());

    var aiRequest = new AiChatbotFreeTextRequestDto(dto.sessionId(), dto.message());
