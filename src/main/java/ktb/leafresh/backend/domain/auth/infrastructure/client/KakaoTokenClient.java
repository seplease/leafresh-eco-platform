...
public class KakaoTokenClient {
  ...
  public void logConfig() {
    log.info("카카오 TokenClient 설정 로드 완료 - clientId={}, clientSecret={}", clientId, clientSecret);
  }
  ...
  public String getAccessToken(String authorizationCode, String redirectUri) {
    ...
    log.debug(
        "AccessToken 요청 준비 - code={}, clientId={}, redirectUri={}",
        authorizationCode,
        clientId,
        redirectUri);
                ...
                clientResponse
                    ...
                    .flatMap(
                        errorBody -> {
                          ...
                          return Mono.error(
                              new IllegalStateException("카카오 AccessToken 요청 실패: " + errorBody));
                        }))
