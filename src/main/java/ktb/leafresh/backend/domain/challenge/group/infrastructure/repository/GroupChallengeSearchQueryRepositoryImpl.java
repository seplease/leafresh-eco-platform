...
public class GroupChallengeSearchQueryRepositoryImpl
    implements GroupChallengeSearchQueryRepository {

  private final JPAQueryFactory queryFactory;
  private final QGroupChallenge gc = QGroupChallenge.groupChallenge;

  @Override
  public List<GroupChallenge> findByFilter(
  ...
  private BooleanExpression likeInput(String input) {
    ...
    return gc.title.containsIgnoreCase(input).or(gc.description.containsIgnoreCase(input));
  }
