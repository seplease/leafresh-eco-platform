  ...
  public static String getImageUrl(String name) {
    return switch (name) {
      ...
      case "CARBON_FOOTPRINT" ->
          "https://storage.googleapis.com/leafresh-images/init/carbon_footprint.png";
      case "ENERGY_SAVING" ->
          "https://storage.googleapis.com/leafresh-images/init/energy_saving.png";
      ...
      case "DIGITAL_CARBON" ->
          "https://storage.googleapis.com/leafresh-images/init/digital_carbon.png";
