...
public enum VerificationErrorCode implements BaseErrorCode {
  ...
  VERIFICATION_LIST_QUERY_FAILED(
  ...
  VERIFICATION_DETAIL_QUERY_FAILED(
      HttpStatus.INTERNAL_SERVER_ERROR, "서버 내부 오류로 인해 인증 상세 정보를 조회하지 못했습니다."),
  ...
  VERIFICATION_COUNT_QUERY_FAILED(
      HttpStatus.INTERNAL_SERVER_ERROR, "서버 내부 오류로 인해 누적 사용자 인증 수 조회에 실패했습니다."),
