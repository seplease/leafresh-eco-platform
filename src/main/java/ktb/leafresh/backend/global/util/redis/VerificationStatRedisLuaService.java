...
public class VerificationStatRedisLuaService {
    ...
    """;
        ...
        try {
            ...
            log.warn("[Lua] {} 실패 - verificationId={}, err={}", actionLabel, verificationId, e.getMessage(), e);
        }
    }
    ...
    private void ensureCacheExists(Long verificationId) {
        ...
        if (Boolean.FALSE.equals(exists)) {
            var stat = groupChallengeVerificationRepository.findStatById(verificationId)
                    .orElseThrow(() -> new IllegalStateException("verificationId not found: " + verificationId));
