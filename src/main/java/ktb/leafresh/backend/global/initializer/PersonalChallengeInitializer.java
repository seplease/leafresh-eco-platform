...
public class PersonalChallengeInitializer implements CommandLineRunner {
  ...
  public void run(String... args) {
    ...
    List<ChallengeSeed> seeds =
        List.of(
            new ChallengeSeed(
                "텀블러 사용하기",
                "일회용 컵 대신 텀블러를 사용해 환경 보호에 동참해요.",
            ...
            new ChallengeSeed(
                "장바구니 사용하기",
                "마트나 편의점에서 장바구니를 챙겨 비닐 사용을 줄여보세요.",
            ...
            new ChallengeSeed(
                "대중교통 이용하기",
                "자가용 대신 버스나 지하철을 이용해 환경 보호에 참여해요.",
    ...
    for (int i = 0; i < seeds.size(); i++) {
      ...
      imageRepository.saveAll(
          List.of(
              PersonalChallenge.of(
                  challenge, seed.success(), ExampleImageType.SUCCESS, "성공 예시입니다.", 1),
              PersonalChallenge.of(
                  challenge, seed.fail(), ExampleImageType.FAILURE, "실패 예시입니다.", 2)));
    }
  }

  private record ChallengeSeed(
      String title, String description, String thumbnail, String success, String fail) {}
}
