...
class ProductPurchaseReadServiceTest {
  ...
  @Mock private ProductPurchaseQueryRepository productPurchaseQueryRepository;

  @InjectMocks private ProductPurchaseReadService productPurchaseReadService;
  ...
  void getPurchases_success() {
    ...
    // when
    ProductPurchaseListResponseDto result =
