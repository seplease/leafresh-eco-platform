...
class TimedealProductReadServiceTest {
    ...
    void findTimedealProducts_cacheHit() {
        // given
        TimedealProductSummaryResponseDto dto = toDto(TimedealPolicyFixture.createOngoingTimedeal(ProductFixture.createDefaultProduct()));
    ...
    void findTimedealProducts_cacheMiss_singleHit() {
        ...
        when(zSetOps.rangeByScore(anyString(), anyDouble(), anyDouble())).thenReturn(Set.of(dto.dealId()));
    ...
    void findTimedealProducts_fallback_success() {
        ...
        TimedealProductSummaryResponseDto fallbackDto = toDto(TimedealPolicyFixture.createOngoingTimedeal(ProductFixture.createDefaultProduct()));
