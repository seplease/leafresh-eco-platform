...
class ProductSearchReadServiceTest {
  ...
  @Mock private ProductSearchQueryRepository productSearchQueryRepository;

  @InjectMocks private ProductSearchReadService productSearchReadService;
  ...
  void search_whenProductsFound_returnsProductList() {
    ...
    ProductListResponseDto result =
        productSearchReadService.search(keyword, cursorId, cursorTimestamp, size);
