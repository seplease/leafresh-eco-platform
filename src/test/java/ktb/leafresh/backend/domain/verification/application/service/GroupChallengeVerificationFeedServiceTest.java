...
class GroupChallengeVerificationFeedServiceTest {
  ...
  @Mock private GroupChallengeVerificationFeedQueryRepository feedQueryRepository;

  @Mock private VerificationStatCacheService verificationStatCacheService;

  @Mock private LikeRepository likeRepository;

  @InjectMocks private GroupChallengeVerificationFeedService feedService;
  ...
  void getGroupChallengeVerifications_withValidInput_returnsPaginatedFeed() {
    ...
    assertThat(dto.challengeId())
        .isEqualTo(verification.getParticipantRecord().getGroupChallenge().getId());
    ...
    assertThat(dto.category())
        .isEqualTo(verification.getParticipantRecord().getGroupChallenge().getCategory().getName());
