...
class GroupVerificationCommentCreateServiceTest {
  ...
  @InjectMocks private GroupVerificationCommentCreateService commentCreateService;
  ...
  void createComment_withValidInput_returnsResponse() {
    ...
    GroupVerificationCommentCreateRequestDto requestDto =
        new GroupVerificationCommentCreateRequestDto(content);
  ...
  void createComment_withInvalidMember_throwsException() {
    ...
    Long challengeId = 100L;
    GroupVerificationCommentCreateRequestDto requestDto =
        new GroupVerificationCommentCreateRequestDto("내용");
    ...
    assertThatThrownBy(
            () ->
                commentCreateService.createComment(
  ...
  void createReply_withValidInput_returnsResponse() {
    ...
    // when
    CommentResponseDto result =
        commentCreateService.createReply(
            challengeId, verificationId, parentCommentId, memberId, requestDto);
  ...
  void createReply_withInvalidParentComment_throwsException() {
    ...
    GroupChallengeVerification verification = GroupChallengeVerificationFixture.of(null);
    GroupVerificationCommentCreateRequestDto requestDto =
        new GroupVerificationCommentCreateRequestDto("대댓글");
  ...
  void createComment_whenUnexpectedExceptionThrown_throwsCreateFailedException() {
    ...
    GroupChallengeVerification verification = GroupChallengeVerificationFixture.of(null);
    GroupVerificationCommentCreateRequestDto requestDto =
        new GroupVerificationCommentCreateRequestDto("예외 테스트");
  ...
  void createReply_whenUnexpectedExceptionThrown_throwsCreateFailedException() {
    ...
    GroupVerificationCommentCreateRequestDto requestDto =
        new GroupVerificationCommentCreateRequestDto("대댓글 예외");
