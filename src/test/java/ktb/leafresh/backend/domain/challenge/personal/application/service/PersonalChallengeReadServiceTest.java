...
class PersonalChallengeReadServiceTest {
  ...
  @InjectMocks private PersonalChallengeReadService readService;
  ...
  void getChallengeDetail_withValidMember_returnsDetail() {
    ...
    List<PersonalChallengeExampleImage> images =
        PersonalChallengeExampleImageFixture.list(challenge);
    ...
    given(
        ...
        .willReturn(
            Optional.of(PersonalChallengeVerificationFixture.of(MemberFixture.of(), challenge)));
  ...
  void getChallengeDetail_withInvalidId_throwsException() {
    ...
    assertThatThrownBy(() -> readService.getChallengeDetail(1L, 999L))
        ...
        .hasMessageContaining(
            ChallengeErrorCode.PERSONAL_CHALLENGE_DETAIL_READ_FAILED.getMessage());
  }
