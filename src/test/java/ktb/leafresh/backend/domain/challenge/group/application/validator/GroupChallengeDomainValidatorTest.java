...
class GroupChallengeDomainValidatorTest {
  ...
  @InjectMocks private GroupChallengeDomainValidator validator;
  ...
  void setUp() {
        ...
        new GroupChallengeCreateRequestDto(
            ...
            List.of(
                new ExampleImageRequestDto(
                    "https://dummy.image/img1.png", ExampleImageType.SUCCESS, "성공 예시", 1)));
    ...
    lenient().when(categoryRepository.findByName("ZERO_WASTE")).thenReturn(Optional.of(category));
  }
    ...
    void validate_withInvalidDateRange_shouldThrow() {
      GroupChallengeCreateRequestDto dto =
          new GroupChallengeCreateRequestDto(
              ...
              baseDto.description(),
              baseDto.category(),
              baseDto.maxParticipantCount(),
              baseDto.thumbnailImageUrl(),
              END,
              START,
              VERIFY_START,
              VERIFY_END,
              baseDto.exampleImages());
    ...
    void validate_withEmptyImages_shouldThrow() {
      ...
      assertThatThrownBy(() -> validator.validate(dto))
          ...
          .hasMessageContaining(
              ChallengeErrorCode.GROUP_CHALLENGE_REQUIRES_SUCCESS_IMAGE.getMessage());
    }
    ...
    void validate_withNoSuccessImage_shouldThrow() {
      GroupChallengeCreateRequestDto dto =
          new GroupChallengeCreateRequestDto(
              ...
              List.of(
                  new ExampleImageRequestDto(
                      "https://dummy.image/img.png", ExampleImageType.FAILURE, "실패 예시", 1)));
  ...
  class UpdateImageValidationFailure {
    ...
    void validateUpdate_withNoSuccessImage_shouldThrow() {
      GroupChallengeUpdateRequestDto dto =
          new GroupChallengeUpdateRequestDto(
              "제로웨이스트 챌린지",
              "설명",
              "ZERO_WASTE",
              100,
              ...
              new GroupChallengeUpdateRequestDto.ExampleImages(
                  ...
                  List.of(
                      new GroupChallengeUpdateRequestDto.ExampleImages.NewImage(
                          "https://dummy.image/fail.png", ExampleImageType.FAILURE, "실패 예시", 1)),
                  List.of() // deleted 없음
                  ));
