...
class GroupChallengeSearchReadServiceTest {
  ...
  @Mock private GroupChallengeSearchQueryRepository searchRepository;

  @InjectMocks private GroupChallengeSearchReadService searchReadService;
  ...
  class GetGroupChallenges {
    ...
    void returnsChallengeListWithoutFilters() {
      ...
      CursorPaginationResult<GroupChallengeSummaryResponseDto> result =
          searchReadService.getGroupChallenges(null, null, null, null, 5);
    ...
    void filtersByCategory() {
      ...
      // when
      var result =
          searchReadService.getGroupChallenges(
              null, GroupChallengeCategoryName.VEGAN, null, null, 5);
