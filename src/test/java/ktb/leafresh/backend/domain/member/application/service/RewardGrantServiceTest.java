...
class RewardGrantServiceTest {
  ...
  @Mock private LeafPointCacheUpdater rewardService;

  @Mock private TreeLevelRepository treeLevelRepository;

  @InjectMocks private RewardGrantService rewardGrantService;
  ...
  class GrantParticipationBonus {
    ...
    @Mock private GroupChallengeParticipantRecord record;

    @Mock private GroupChallenge challenge;
